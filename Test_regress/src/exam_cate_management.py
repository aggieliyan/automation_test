...
def modify_exam_cate(cfg,driver, base_url,org_name):
    ...
    driver.find_element(cfg.get('exam','cate_mod_by'),cfg.get('exam','cate_mod_xpath')).click()
...
def delete_exam_cate(cfg,driver, base_url,org_name):
    ...
    driver.find_element_by_link_text(u"类目管理").click()
    driver.implicitly_wait(10)
    driver.find_element(cfg.get('exam','cate_del_by'),cfg.get('exam','cate_del_xpath')).click()
    driver.implicitly_wait(10)
    driver.find_element(cfg.get('exam','cate_oknew_button_by'),cfg.get('exam','cate_oknew_button')).click()
    driver.implicitly_wait(10)
...
def create_exam_point(cfg,driver, base_url,org_name,point_name,point_detail,other_groom):
    ...
    driver.find_element(cfg.get('exam','point_address_by'),cfg.get('exam','point_address_xpath1')).click()
    driver.implicitly_wait(10)
    driver.find_element(cfg.get('exam','point_address_by'),cfg.get('exam','point_address_xpath2')).click()
    driver.implicitly_wait(10)
...
def delete_exam_point(cfg,driver, base_url, org_name):
    ...
    driver.find_element_by_link_text(u"考点库").click()
    driver.implicitly_wait(10)
    driver.find_element(cfg.get('exam','point_delete_by'),cfg.get('exam','point_delete_xpath')).click()
    driver.implicitly_wait(10)
