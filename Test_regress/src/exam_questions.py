...
def exam_questions(cfg,driver, base_url,question_ansa):
    ...
    time.sleep(2) 
    #创建单选题   
    driver.find_element(cfg.get('exam_questions',"question_creat_by"),cfg.get('exam_questions',"question_creat")).click()
    time.sleep(2)
    ...
    idocument=element.contentDocument;element=idocument.getElementById('tinymce');element.innerHTML =\'" + question_ansa + "\';")
    time.sleep(2)
    driver.find_element(cfg.get('exam_questions',"question_save_by"),cfg.get('exam_questions',"question_save")).click()
    time.sleep(2)
    driver.find_element_by_link_text("单选题").click()
    time.sleep(2)
    ...
    driver.find_element(cfg.get('exam_questions',"question_creat_by"),cfg.get('exam_questions',"question_creat")).click()
    time.sleep(2)
    driver.find_element(cfg.get('exam_questions',"question_type_by"),cfg.get('exam_questions',"question_type")).click()
    time.sleep(2)
    driver.find_element(cfg.get('exam_questions',"question_type_duoxuan_by"),cfg.get('exam_questions',"question_type_duoxuan")).click()
    time.sleep(2)
    iframe_id = driver.execute_script("return $('#sbjFormCon iframe:eq(0)').attr('id')")    
    driver.execute_script("var element=window.document.getElementById(\'" + iframe_id + "\');\
    idocument=element.contentDocument;element=idocument.getElementById('tinymce');element.innerHTML =\'" + question_ansa + "\';")
    ...
    driver.find_element(cfg.get('exam_questions',"question_type_by"),cfg.get('exam_questions',"question_type")).click()
    time.sleep(2)
    driver.find_element(cfg.get('exam_questions',"question_type_shifei_by"),cfg.get('exam_questions',"question_type_shifei")).click()
    time.sleep(2)
    iframe_id = driver.execute_script("return $('#sbjFormCon iframe:eq(0)').attr('id')")    
    driver.execute_script("var element=window.document.getElementById(\'" + iframe_id + "\');\
    idocument=element.contentDocument;element=idocument.getElementById('tinymce');element.innerHTML =\'" + question_ansa + "\';")
...
#    time.sleep(2)
    ...
    driver.find_element(cfg.get('exam_questions',"question_type_by"),cfg.get('exam_questions',"question_type")).click()
    time.sleep(2)
    driver.find_element(cfg.get('exam_questions',"question_type_wenda_by"),cfg.get('exam_questions',"question_type_wenda")).click()
    time.sleep(2)
    iframe_id = driver.execute_script("return $('#sbjFormCon iframe:eq(0)').attr('id')")    
    driver.execute_script("var element=window.document.getElementById(\'" + iframe_id + "\');\
    idocument=element.contentDocument;element=idocument.getElementById('tinymce');element.innerHTML =\'" + question_ansa + "\';")
    ...
    driver.find_element(cfg.get('exam_questions',"question_type_by"),cfg.get('exam_questions',"question_type")).click()
    time.sleep(2)
    driver.find_element(cfg.get('exam_questions',"question_type_tiankong_by"),cfg.get('exam_questions',"question_type_tiankong")).click()
    time.sleep(2)
    iframe_id = driver.execute_script("return $('#sbjFormCon iframe:eq(0)').attr('id')")    
    driver.execute_script("var element=window.document.getElementById(\'" + iframe_id + "\');\
    idocument=element.contentDocument;element=idocument.getElementById('tinymce');element.innerHTML =\'" + question_ansa + "\';")
    ...
    driver.find_element(cfg.get('exam_questions',"question_tiankonganswer_by"),cfg.get('exam_questions',"question_tiankonganswer")).send_keys(question_ansa)
    time.sleep(2)
    driver.find_element(cfg.get('exam_questions',"question_save_by"),cfg.get('exam_questions',"question_save")).click()
    time.sleep(2)
    driver.find_element_by_link_text("单选题").click()
    ...
    driver.find_element(cfg.get('exam_questions',"question_type_by"),cfg.get('exam_questions',"question_type")).click()
    time.sleep(2)
    driver.find_element(cfg.get('exam_questions',"question_type_wanxing_by"),cfg.get('exam_questions',"question_type_wanxing")).click()
    time.sleep(2)
    iframe_id = driver.execute_script("return $('#sbjFormCon iframe:eq(0)').attr('id')")    
    driver.execute_script("var element=window.document.getElementById(\'" + iframe_id + "\');\
    idocument=element.contentDocument;element=idocument.getElementById('tinymce');element.innerHTML =\'" + question_ansa + "\';")
    time.sleep(2)
    driver.find_element(cfg.get('exam_questions',"question_wanxinganswer1_by"),cfg.get('exam_questions',"question_wanxinganswer1")).send_keys(question_ansa)
    time.sleep(2)
    driver.find_element(cfg.get('exam_questions',"question_wanxinganswer2_by"),cfg.get('exam_questions',"question_wanxinganswer2")).send_keys(question_ansa)
    time.sleep(2)
    driver.find_element(cfg.get('exam_questions',"question_wanxinganswer3_by"),cfg.get('exam_questions',"question_wanxinganswer3")).send_keys(question_ansa)
    time.sleep(2)
    driver.find_element(cfg.get('exam_questions',"question_wanxinganswer4_by"),cfg.get('exam_questions',"question_wanxinganswer4")).send_keys(question_ansa)
    time.sleep(2)
    driver.find_element(cfg.get('exam_questions',"question_save_by"),cfg.get('exam_questions',"question_save")).click()
    time.sleep(2)
    driver.find_element_by_link_text("单选题").click()
    ...
    driver.find_element(cfg.get('exam_questions',"question_type_by"),cfg.get('exam_questions',"question_type")).click()
    time.sleep(2)
    driver.find_element(cfg.get('exam_questions',"question_type_zonghe_by"),cfg.get('exam_questions',"question_type_zonghe")).click()
    time.sleep(2)
    iframe_id = driver.execute_script("return $('#sbjFormCon iframe:eq(0)').attr('id')")    
    driver.execute_script("var element=window.document.getElementById(\'" + iframe_id + "\');\
    idocument=element.contentDocument;element=idocument.getElementById('tinymce');element.innerHTML =\'" + question_ansa + "\';")
