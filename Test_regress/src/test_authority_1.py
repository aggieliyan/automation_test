...
def creat_stucate():
	...
	try:
	   driver.find_element_by_id("reg_textField").send_keys(cate_name)#输入类目名称
		...
		None		
	time.sleep(1)
	driver.find_element_by_class_name("x-btn-text").click()#确定		
	time.sleep(1)
...
def stuoremp_stumanage():
	...
	try:
		...
		time.sleep(1)
		driver.find_element_by_link_text(u"延迟授权").click()#延长授权
		time.sleep(1)
...
#	try:
#		#逐一导入手动导入测试
#		driver.find_element_by_link_text("批量导入员工").click()#批量导入员工
#		time.sleep(1)
#		driver.find_element_by_link_text("返回").click()
#		time.sleep(2)
#		driver.find_element_by_link_text("批量创建员工").click()#批量创建员工
#		time.sleep(1)
#		driver.find_element_by_link_text("返回").click()
#		time.sleep(2)
#		student_management.open_course_for_one(cfg, driver, base_url, org_name)#开通课程
...
#	time.sleep(2)
#	try:
#	    driver.find_element_by_link_text(u"删除学员").click()#删除员工
#	    time.sleep(1)
#	    driver.find_element_by_class_name("x-btn-text").click()#点击确定
#	    time.sleep(1)	
#	except Exception:
...
#	current_url = driver.current_url
#	try:
#	    driver.find_element_by_("J_stuType").click()#选择学员类型
#	    time.sleep(1)
...
#	    time.sleep(1)
# 	    bh = driver.window_handles
#	    driver.find_element_by_link_text(u"详情").click()#点击查询
#	    time.sleep(1)
#	    ah = driver.window_handles
#	    swithing_window(bh,ah)
#	    time.sleep(1)
